            ...
            <table class="ui celled table" id="example" style="width:100%; margin-left: auto;">
                ...
                while($result=mysqli_fetch_row($infosCommandes))
                {
                    ...
                    <tr>
                        ...
                        <td><center><a class='btn btn-info btn-xs' href='../../view/commande/detail.php?num=$result[0]'>Détail</a></center></td>
                        <td><center><a class='btn btn-success btn-xs' href='../../view/commande/bon.php?num=$result[0]'>Bon de commande</a></center></td>
                        <td><center><a class='btn btn-danger btn-xs' href='../../view/commande/detail.php?num=$result[0]'>Supprimer</a></center></td>
                    </tr>
                    ";
                }
